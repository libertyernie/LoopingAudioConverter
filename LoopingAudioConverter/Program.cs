		...
		public static void Run(Options o) {
			...
			switch (o.ExporterType) {
				case ExporterType.BRSTM:
					exporter = new RSTMExporter(DspAdpcm.Adpcm.Formats.Structures.B_stmCodec.Adpcm);
					break;
				case ExporterType.BRSTM_PCM16:
					exporter = new RSTMExporter(DspAdpcm.Adpcm.Formats.Structures.B_stmCodec.Pcm16Bit);
					break;
