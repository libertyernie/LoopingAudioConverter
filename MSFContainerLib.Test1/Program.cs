            ...
            {
                {
                    ...
                    Console.WriteLine($"Little endian: new [] {{ {string.Join(",", hash_le.Select(x => "0x" + ((int)x).ToString("X2")))} }}");
                ...
                }
                {
                    ...
                    Console.WriteLine($"Big endian: new [] {{ {string.Join(",", hash_be.Select(x => "0x" + ((int)x).ToString("X2")))} }}");
